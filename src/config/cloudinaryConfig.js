...
export const uploadImageToCloudinary = async (imgFile, folderName) => {
  ...
  formData.append('upload_preset', 'outFitx'); // Replace 'vamfilm' with your actual unsigned upload preset name
  formData.append('cloud_name', 'dut8niaqi'); // Replace 'dymypfkt4' with your actual Cloudinary cloud name
  ...
  try {
    const response = await fetch(`https://api.cloudinary.com/v1_1/dut8niaqi/image/upload`, {
      method: 'POST',
      body: formData,
    });
