...
function Home() {
  const products = [
    {
      image:
        "https://images.unsplash.com/photo-1520975916090-3105956dac38?q=80&w=1640&auto=format&fit=crop",
      title: "Áo thun basic",
      price: "249.000đ",
      badge: "New",
    },
    ...
    {
      image:
        "https://images.unsplash.com/photo-1520975693411-b39e99a6d63a?q=80&w=1640&auto=format&fit=crop",
      title: "Quần jean slim",
      price: "549.000đ",
    },
    {
      image:
        "https://images.unsplash.com/photo-1520975582033-6c3c63f22c65?q=80&w=1640&auto=format&fit=crop",
      title: "Váy midi tôn dáng",
      price: "629.000đ",
      badge: "Hot",
    },
    {
      image:
        "https://images.unsplash.com/photo-1520975661595-6453be3f7070?q=80&w=1640&auto=format&fit=crop",
    ...
    },
    {
      ...
      title: "Giày sneaker retro",
      price: "899.000đ",
    },
    {
      image:
        "https://images.unsplash.com/photo-1520975804745-4e855d255f8b?q=80&w=1640&auto=format&fit=crop",
      title: "Áo polo dệt mịn",
      price: "329.000đ",
    },
    {
      image:
    ...
    <main>
      <section className="relative">
        <div className="absolute inset-0 -z-10">
          <img src="/public/video 4k.mp4" alt="bg" className="hidden" />
        </div>
      ...
      <div className="grid items-center gap-10 py-12 md:grid-cols-2 md:py-20">
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            ...
            <a
              href="#sale"
              className="inline-flex items-center rounded-full border border-neutral-300 px-5 py-2.5 text-sm font-semibold hover:bg-neutral-100 transition"
            >
              Ưu đãi tháng này
            </a>
          </div>
        ...
        <div className="relative">
          ...
          {/* Chữ nổi ở giữa dưới ảnh */}
          <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 z-50 rounded-full bg-white/90 backdrop-blur-sm px-5 py-2 shadow-md border text-sm font-semibold text-gray-800">
